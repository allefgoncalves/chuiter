...
void *messages_from_all_users(TrieNode *root, long long int a, long long int b, const char *name, int *Qtd); //exibe as mensagens de todos os usuarios em um intervalo A-B
